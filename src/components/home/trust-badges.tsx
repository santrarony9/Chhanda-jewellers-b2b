                ...
                <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-white/5">
                    {badges.map((badge, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="flex flex-col items-center text-center px-2 py-4 md:px-4 md:py-6 group relative rounded-lg transition-colors hover:bg-white/5"
                            whileHover={{ y: -5 }}
                        >
                            ...
                            <div className="mb-4 p-3 md:p-4 rounded-full border border-white/10 group-hover:border-primary/50 transition-all duration-300 group-hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] bg-black">
                                <badge.icon className="h-6 w-6 text-gray-400 group-hover:text-primary transition-colors" />
                            </div>
                            <h3 className="font-serif font-bold text-white text-sm md:text-lg mb-1 group-hover:text-primary-100 transition-colors">{badge.title}</h3>
