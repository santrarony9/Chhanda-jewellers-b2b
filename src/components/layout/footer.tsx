            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <FooterLink href="/products?cat=gold">Gold Jewellery (22K/18K)</FooterLink>
                            <FooterLink href="/products?cat=diamond">Diamond Jewellery</FooterLink>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-gray-400 text-sm">
                                ...
                                <span>Singur, Hooghly, West Bengal, India - 712409</span>
                            </li>
                            ...
                            <li className="flex items-center gap-3 text-gray-400 text-sm">
                                ...
                                <span>contact@chhandajewellers.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
